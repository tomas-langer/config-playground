 ...
 * <a href="#discovery">discovered</a> or explicitly {@linkplain jakarta.config.spi.ConfigBuilder#withConverter(Class, int, Converter)
 ...
 * <p>
 * It is also possible to explicitly register a global converter to a {@linkplain jakarta.config.spi.ConfigBuilder configuration builder}
 * using the {@link jakarta.config.spi.ConfigBuilder#withConverters(Converter[])} and
 * {@link jakarta.config.spi.ConfigBuilder#withConverter(Class, int, Converter)} methods.
 *
 ...
 * {@linkplain jakarta.config.spi.ConfigBuilder#withConverter(Class, int, Converter) builder method}.
 * <p>

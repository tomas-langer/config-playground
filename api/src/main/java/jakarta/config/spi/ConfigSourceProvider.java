 ...
 * <p>
 * Implementations of this interface may supply zero or more {@linkplain jakarta.config.spi.ConfigSource configuration source} instances
 * for a given application (as defined by the application's {@link ClassLoader}).
 * <p>
 * Instances of this interface will be {@linkplain jakarta.config.spi.ConfigBuilder#addDiscoveredSources() discovered} via the
...
public interface ConfigSourceProvider {
    /**
     * Return the {@link jakarta.config.spi.ConfigSource} instances that are provided by this provider. The {@link java.lang.Iterable
     * Iterable} contains a fixed number of {@linkplain jakarta.config.spi.ConfigSource configuration sources}, determined at application
     ...
     * @return the {@link jakarta.config.spi.ConfigSource} instances to register to the configuration
     */

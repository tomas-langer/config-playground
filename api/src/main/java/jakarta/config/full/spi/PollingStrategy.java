 ...
 * tree, as accessed through {@link jakarta.config.full.spi.PollableConfigSource}s.
 */
@FunctionalInterface
public interface PollingStrategy {
     ...
     *  events on {@link jakarta.config.full.spi.PollingStrategy.Polled#poll(java.time.Instant)}.
    ...
    interface Polled {
        /**
         * Poll for changes.
         * The result may be used to modify behavior of the {@link jakarta.config.full.spi.PollingStrategy} triggering this
         * poll event.
         *

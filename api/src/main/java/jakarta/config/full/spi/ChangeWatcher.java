...
/**
 * Similar to a {@link PollingStrategy} a change watcher is used to
 * identify a change and trigger reload of a {@link ConfigSource}.
...
public interface ChangeWatcher<T> {
    ...
    interface ChangeEvent<T> {
         ...
         * This may be the same as the target of {@link jakarta.config.full.spi.ChangeWatcher},

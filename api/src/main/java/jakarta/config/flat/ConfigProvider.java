...
import jakarta.config.flat.spi.ConfigProviderResolver;
 ...
 * <em>{@linkplain jakarta.config.flat.spi.ConfigSource configuration sources}</em>, combined with the set
 * of registered {@linkplain jakarta.config.flat.spi.Converter converters}. The <em>configuration
 * sources</em> get sorted according to their
 * <em>{@linkplain jakarta.config.flat.spi.ConfigSource#getOrdinal() ordinal value}</em>. Thus it is

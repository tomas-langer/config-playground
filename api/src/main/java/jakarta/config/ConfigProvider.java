...
/**
 * This is the central class to access a {@link jakarta.config.Config}.
 * <p>
 * A {@link jakarta.config.Config} provides access to the application's configuration. It may have been automatically discovered, or
 ...
 *
 * <p>
 * For more advanced use cases (e.g. registering a manually created {@link jakarta.config.Config} instance), please see
 * {@link ConfigProviderResolver#registerConfig(jakarta.config.Config, ClassLoader)} and {@link ConfigProviderResolver#getBuilder()}.
 *
...
public final class ConfigProvider {
    ...
    /**
     * Get the {@linkplain jakarta.config.Config configuration} corresponding to the current application, as defined by the calling
     * thread's {@linkplain Thread#getContextClassLoader() context class loader}.
     * <p>
     * The {@link jakarta.config.Config} instance will be created and registered to the context class loader if no such configuration
     ...
     */
    public static jakarta.config.Config getConfig() {
        return ConfigProviderResolver.instance().getConfig();
    }

    /**
     * Get the {@linkplain jakarta.config.Config configuration} for the application corresponding to the given class loader instance.
     * <p>
     * The {@link jakarta.config.Config} instance will be created and registered to the given class loader if no such configuration is
